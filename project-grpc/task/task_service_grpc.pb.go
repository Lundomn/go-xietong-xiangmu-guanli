...
type TaskServiceClient interface {
	...
	TaskDone(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskMessage, error)
	TaskEdit(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskMessage, error)
	TaskAssign(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskMessage, error)
	FileAction(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskSourceMessage, error)
...
func (c *taskServiceClient) TaskDone(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskMessage, error) {
	out := new(TaskMessage)
	err := c.cc.Invoke(ctx, "/task.service.v1.TaskService/TaskDone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) TaskEdit(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskMessage, error) {
	out := new(TaskMessage)
	err := c.cc.Invoke(ctx, "/task.service.v1.TaskService/TaskEdit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) TaskAssign(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskMessage, error) {
	out := new(TaskMessage)
	err := c.cc.Invoke(ctx, "/task.service.v1.TaskService/TaskAssign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) FileAction(ctx context.Context, in *TaskReqMessage, opts ...grpc.CallOption) (*TaskSourceMessage, error) {
	out := new(TaskSourceMessage)
	err := c.cc.Invoke(ctx, "/task.service.v1.TaskService/FileAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	TaskDone(context.Context, *TaskReqMessage) (*TaskMessage, error)
	TaskEdit(context.Context, *TaskReqMessage) (*TaskMessage, error)
	TaskAssign(context.Context, *TaskReqMessage) (*TaskMessage, error)
	FileAction(context.Context, *TaskReqMessage) (*TaskSourceMessage, error)
...
func (UnimplementedTaskServiceServer) TaskDone(context.Context, *TaskReqMessage) (*TaskMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskDone not implemented")
}
func (UnimplementedTaskServiceServer) TaskEdit(context.Context, *TaskReqMessage) (*TaskMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskEdit not implemented")
}
func (UnimplementedTaskServiceServer) TaskAssign(context.Context, *TaskReqMessage) (*TaskMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskAssign not implemented")
}
func (UnimplementedTaskServiceServer) FileAction(context.Context, *TaskReqMessage) (*TaskSourceMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FileAction not implemented")
}
...
func _TaskService_TaskDone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.service.v1.TaskService/TaskDone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskService_TaskEdit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskReqMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).TaskEdit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.service.v1.TaskService/TaskEdit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).TaskEdit(ctx, req.(*TaskReqMessage))
	}
	return interceptor(ctx, in, info, handler)
}

func _TaskService_TaskAssign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskReqMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).TaskAssign(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.service.v1.TaskService/TaskAssign",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).TaskAssign(ctx, req.(*TaskReqMessage))
	}
	return interceptor(ctx, in, info, handler)
}

func _TaskService_FileAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskReqMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).FileAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.service.v1.TaskService/FileAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).FileAction(ctx, req.(*TaskReqMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TaskEdit",
			Handler:    _TaskService_TaskEdit_Handler,
		},
		{
			MethodName: "TaskAssign",
			Handler:    _TaskService_TaskAssign_Handler,
		},
		{
			MethodName: "FileAction",
			Handler:    _TaskService_FileAction_Handler,
		},
		{
