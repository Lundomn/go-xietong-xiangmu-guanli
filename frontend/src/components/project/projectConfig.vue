<template>
    <a-tabs tabPosition="left" defaultActiveKey="1" :animated="false" v-model="tabKey">
        ...
        <a-tab-pane v-if="false" key="4" forceRender>
             <span slot="tab">
            ...
            <div class="config-content more-config">
                <div class="content-item">
                    <div class="infos">
                        ...
                        <a-button v-if="false" size="large" class="middle-btn" @click="archiveProject">
                            <span v-if="project.archive">取消归档</span>
                            <span v-if="!project.archive">归档项目</span>
                        </a-button>
                        <a-button v-if="false" size="large" class="middle-btn" @click="quitProject">退出</a-button>
