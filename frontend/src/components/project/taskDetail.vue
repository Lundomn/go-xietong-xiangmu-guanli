                             ...
                             <a-dropdown :trigger="['click']" placement="bottomCenter" v-model="visibleTaskMenu">
                              <a-tooltip :mouseEnterDelay="0.5">
                                ...
                                <a-menu @click="doTask" class="field-right-menu"
                                    ...
                                    <a-menu-item v-if="false" key="move">
                                    ...
                                    <a-menu-item v-if="false" key="recycle">
                                                            ...
                                                            <div class="list-item task m-l-xs">
                                                                <div class="task-item task-title hover-none">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {{workTime.member ? workTime.member.name : '待认领'}}
                                                                ...
                                                                <a v-if="false" class="muted" @click="doWorkTime(workTime)">
                                                                    <a-icon class="task-item" type="edit"/>
                                                                </a>
                                                                <a v-if="false" class="muted"
                                                    ...
                                                    <a-list>
                                                        <a-list-item :key="index"
                                                            ...
                                                            <a class="muted" href="javascript:void(0)"
                                                                       @click="downloadFile(item)">{{ item.title
                                                                        }}</a>
                                                                </div>
                                                            ...
                                                            <a class="muted" slot="actions">
                                                                <a-dropdown :trigger="['click']"
                                                                    ...
                                                                    <a-menu-item v-if="false" key="unlink">
                    ...
                    <div class="content-right">
                        <div class="header">
                            ...
                            <div class="member-list">
                                ...
                                <a-dropdown v-if="false" :trigger="['click']" placement="bottomCenter"
    ...
    export default {
        ...
        data() {
            return {
                ...
                hasMoreDesc: false,
                editorConfig: {
                    // 当前后端只提供任务附件上传，富文本图片接口不再指向不存在的旧地址。
                    uploadImgServer: '',
                    uploadImgHeaders: {},
                    menus: [
                        'head',	// 标题
        ...
        methods: {
            ...
            downloadFile(item) {
                const detail = item && item.sourceDetail;
                if (!detail || !detail.file_url) {
                    return;
                }
                downloadAuthenticated(detail.file_url, item.title || detail.fullName || '下载文件')
