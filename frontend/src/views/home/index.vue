...
<!--                                            <a-avatar size="small" :src="item.cover"/>-->
                ...
                <a-col
                    ...
                    <a-card v-if="false" class="events-list" :loading="events.loading" :title="`日程 · ${events.eventList.length}`" :bordered="false"  style="margin-bottom: 24px">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getEvents() {
                // 日程模块依赖旧版事件服务，当前部署版暂不把它放入工作台。
                this.events.loading = false;
                this.events.loadingMore = false;
            },
            getYiYan() {
                let app = this;
