    ...
    export default {
        ...
        computed: {
            ...
            layoutClass() {
                ...
                const info = this.$route.meta && this.$route.meta.info;
                if (info && !info.show_slider) {
                    className += ' hide';
                }
                return className;
            }
        ...
        methods: {
            ...
            checkLayout() {
                ...
                const info = meta.info || {title: '', fullUrl: '', is_inner: true, show_slider: false};
                that.breadCrumbInfo = [];
            ...
            menuClick(event, menu) {
                //点击左侧导航跳转页面
                let that = this;
                if (!menu || !Array.isArray(that.menus)) {
                    return;
                }
                let openKeys = [];
