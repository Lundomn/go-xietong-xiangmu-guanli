...
type MemberRepo interface {
	...
	FindMemberByAccount(ctx context.Context, account string) (mem *member.Member, err error)
	UpdateMemberPassword(ctx context.Context, id int64, password string) error
